...
team_t team = {
    ...
    "Andrew Nyaisonga",     /* First member full name */
    "anyaison@u.rochester.edu",  /* First member email address */
...
/*
The concept is the same with the trivia, just do as many operation as possible inside the second loop before the jump
 */
